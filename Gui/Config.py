...
class FrmConfig ( wx.Dialog ):
	...
	def __init__( self, parent ):
		wx.Dialog.__init__ ( self, parent, id = wx.ID_ANY, title = u"Configuration", pos = wx.DefaultPosition, size = wx.Size( 460,170 ), style = wx.DEFAULT_DIALOG_STYLE|wx.STAY_ON_TOP )
		...
		self.m_staticText12 = wx.StaticText( self.m_panel3, wx.ID_ANY, u"In order to configurate py2Nsis you have to especify the path to your makensisw.exe file", wx.DefaultPosition, wx.DefaultSize, 0 )
		...
		self.m_staticText121 = wx.StaticText( self.m_panel3, wx.ID_ANY, u"Atention: (Ensure you have Python in your environment variables)", wx.DefaultPosition, wx.DefaultSize, 0 )
