...
class FrmMain ( wx.Frame ):
    ...
    def __init__( self, parent ):
        wx.Frame.__init__ ( self, parent, id = wx.ID_ANY, title = u"py2Nsis", pos = wx.DefaultPosition, size = wx.Size( 480,800 ), style = wx.DEFAULT_FRAME_STYLE|wx.TAB_TRAVERSAL )
        ...
        self.btPy2exe = wx.BitmapButton( self.m_panel1, wx.ID_ANY, wx.Bitmap( u"Images/py2nsis.png", wx.BITMAP_TYPE_ANY ), wx.DefaultPosition, wx.DefaultSize, wx.BU_LEFT )
        bSizer201.Add( self.btPy2exe, 1, wx.ALL, 5 )

        self.btpyInstaller = wx.BitmapButton( self.m_panel1, wx.ID_ANY, wx.Bitmap( u"Images/py2nsis.png", wx.BITMAP_TYPE_ANY ), wx.DefaultPosition, wx.DefaultSize, wx.BU_LEFT )
        ...
        self.btGenerate1 = wx.Button( self.m_panel1, wx.ID_ANY, u"Generate", wx.DefaultPosition, wx.DefaultSize, 0 )
